  ...
  <div class="page active" id="page-dashboard">
    ...
    <div class="quick-grid">
      ...
      <div class="quick-card" onclick="navigate('sickness','Submit Sickness Report')">
    ...
    <div class="section-heading" style="margin-top:32px;">
      ...
      <button class="btn btn-primary" onclick="navigate('sickness','Submit Sickness Report')">+ Submit Report</button>
    </div>
    <div class="card">
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ...
            @empty
            <tr><td colspan="12" style="text-align:center;padding:40px;color:#6a7a8a;">
              <i class="fas fa-file-medical" style="font-size:40px;display:block;margin-bottom:10px;color:#c8d0d8;"></i>
              No sickness reports submitted yet. Go to <strong>Sickness Reports</strong> page to submit a new report.
            </td></tr>
            @endforelse
          </tbody>
        </table>
